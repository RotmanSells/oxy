const translations = {
    ru: {
        ...
        service_tourism: "Туризм",
        service_tourism_desc: "Создание туристических комплексов, операционный запуск, управление отелями и рекреационными объектами.",
        ...
        service_land_desc: "Подбор и оформление земельных участков под строительство и туристический бизнес. Через официального партнёра DIGNISI — покупка и продажа недвижимости в Ереване и Армении: квартиры, апартаменты, коммерческая недвижимость. Юридическое сопровождение, проверка кредитоспособности в офисе.",
    ...
    en: {
        ...
        service_tourism_desc: "Creating tourist complexes, operational launch, management of hotels and recreational facilities.",
        ...
        service_land_desc: "Selection and registration of land plots for construction and tourism. Through official partner DIGNISI — buying and selling real estate in Yerevan and Armenia: apartments, residences, commercial property. Legal support, creditworthiness check at the office.",
    ...
    hy: {
        ...
        service_land_desc: "Հողամասերի ընտրություն և ձևակերպում շինարարության և տուրիզմի համար։ Պաշտոնական գործընկեր DIGNISI-ի միջոցով՝ անշարժ գույնի գնում և վաճառք Երևանում և Հայաստանում՝ բնակարաններ, կենցաղային տարածքներ, կոմերցիոն գույք։ Իրավական ուղեկցում, վարկային ունակության ստուգում գրասենյակում։",
